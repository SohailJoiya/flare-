        ...
        <div className={`relative bg-brand-surface/70 backdrop-blur-xl border border-white/10 rounded-3xl shadow-2xl overflow-hidden ${isClosing ? 'animate-scale-out' : 'animate-scale-in'}`}>
            ...
            <div className="relative p-8">
                ...
                <div className="text-center -mt-4">
                    ...
                    <p className="text-2xl font-bold text-brand-primary mt-1 mb-6">{plan.range}</p>
                </div>
                ...
                <div className="space-y-4">
                    ...
                    <div className="bg-brand-dark/50 p-4 rounded-xl border border-white/10">
                        <h3 className="text-lg font-semibold text-brand-primary mb-3">Official Binance Account</h3>
                        ...
                        <div>
                            ...
                            >
                                ...
                                <span className="text-sm font-sans font-semibold text-brand-primary">
                                    {copied ? 'Copied!' : 'Copy'}
                                </span>
                            </div>
                        </div>

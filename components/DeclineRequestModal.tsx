    ...
    <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50 p-4" role="dialog" aria-modal="true">
      <Card className="w-full max-w-lg">
        ...
        <p className="text-sm text-gray-400 mb-6">
          Send a notification to <span className="font-semibold text-brand-primary">{userEmail}</span> with the reason for declining.
        </p>
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full bg-gray-800 border border-gray-600 rounded-md p-2.5 text-white focus:ring-brand-primary focus:border-brand-primary transition"
            />
          </div>

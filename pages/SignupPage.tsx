    ...
    <div className='min-h-screen flex items-center justify-center bg-brand-dark p-4'>
      <Card className='w-full max-w-md'>
        <div className='text-center mb-6'>
          <h1 className='text-4xl font-black text-brand-primary leading-none flare-animated'>
            FLARE
          </h1>
        ...
        <form
          ...
          <div>
            <Input
              ...
              disabled={isLoading}
              className={
                !!referralCode ? 'bg-gray-800/60 cursor-not-allowed' : ''
              }
            />
            {referralCode && (
              <p className='mt-2 text-sm text-green-400 flex items-center'>
                ...
                Referral code{' '}
                <strong className='font-semibold mx-1 text-green-300 truncate'>
                  {referralCode}
                </strong>{' '}
                applied.
              </p>

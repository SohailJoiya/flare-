...
const App: React.FC = () => {
  ...
  useEffect(() => {
    ...
    // This logic relies on the server being configured to handle SPA routing (e.g., with .htaccess).
    // All unknown paths should be redirected to index.html to let the app handle the route.
    const path = window.location.pathname;
    const urlParams = new URLSearchParams(window.location.search);

    let referralCode: string | null = null;
    
    // Handles /register?ref=CODE

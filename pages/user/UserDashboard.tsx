...
const UserDashboard: React.FC<UserDashboardProps> = ({ user, onNavigate, dailyClaim, onClaimSuccess }) => {
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <Card>
          ...
          <div className="flex items-center bg-gray-800 rounded-md p-2 border border-gray-600">
            ...
            <button onClick={copyReferralLink} className="ml-2 px-3 py-1 bg-brand-primary text-white rounded text-sm">
      ...
      {/* Claim Daily Profit */}
       <Card className="bg-gradient-to-r from-brand-primary/10 to-transparent">

        ...
        <div className="space-y-12 max-w-6xl mx-auto">
            ...
            <Card>
                ...
                <div className="w-full bg-gray-700/50 rounded-full h-5 border border-gray-600">
                    <div className="bg-gradient-to-r from-rose-500 to-brand-primary h-full rounded-full transition-all duration-500" style={{ width: `${progressPercentage}%` }}></div>
                </div>
            ...
            <Card>
                ...
                <div className="space-y-4 text-gray-300">
                    ...
                    <div className="bg-brand-dark/50 p-4 rounded-lg border border-gray-700">
                        ...
                        <p className="text-sm">If your team (including your own investment) collectively invests <strong className="text-brand-primary">$5,500</strong> in November, you will qualify for the <strong className="text-purple-300">Motivator</strong> tier and receive a <strong className="text-green-400">$750</strong> bonus at the end of the month.</p>
                    </div>
                </div>
            </Card>
